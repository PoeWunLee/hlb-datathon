...
sidebar = html.Div([
        ...
        html.Hr(),
        dbc.Nav([
            dbc.NavItem(dbc.NavLink("HLB Datathon 2020", active=True,href="https://www.hlb.com.my/hlbdatathon/", style={"color":"white"})),
            html.Br(),
            dbc.NavItem(dbc.NavLink("GitHub", active=True,href="https://github.com/junwenkwan/hong-leong-bank-datathon",style={"color":"white"})),
            html.Br(),
